...
public class StudentCourse implements java.io.Serializable
{
	...
	/*
	 * public Set getStudentClasses() { return this.studentClasses; }
	 * 
	 * public void setStudentClasses(Set studentClasses) { this.studentClasses =
	 * studentClasses; }
	 */
	...
	public String toString()
	{
		return "StudentCourse [studentCourseId=" + studentCourseId
				+ ", student=" + student + ", courseTeacher=" + courseTeacher
				+ "]";
	}
